...
<head>
    ...
    <title>7 Days Kilimanjaro Trekking via Lemosho Route | Tanzania Adventure</title>
    <meta name="description" content="Experience the ultimate 7-day Kilimanjaro trek via the scenic Lemosho Route with camping accommodations and expert guides.">
    <meta name="keywords"content="7 days Kilimanjaro trek, Lemosho route, Kilimanjaro climbing, Tanzania trekking, mountain hiking, Africa adventure">
...
<section class="packages-hero-kili">
        ...
        <div class="packages-hero-kili-content">
            <h1>7 Days Kilimanjaro Trekking via Lemosho Route</h1>
            <p>Kilimanjaro's most scenic and diverse route with excellent acclimatization on our 7-day Lemosho itinerary.</p>
    ...
    <div class="container">
        <div class="overview-content">
            <div class="overview-header">
                <h2>7 Days Lemosho Route Overview</h2>
                <div class="route-badge">Premium Wilderness Experience</div>
            </div>
        ...
        <div class="gallery-layout">
            ...
            <div class="large-image">
                <img src="img/lemosho-8-day-safari.jpg" alt="Kilimanjaro Lemosho Route Experience">
            </div>
            ...
            <div class="right-images">
                ...
                <div class="small-image">
                    <img src="img/7-day-lemosho-route.jpg" alt="Lemosho Route Landscape">
                </div>
                
                <!-- Small Image 2 -->
                <div class="small-image">
                    <img src="img/7-day-lemosho-climbing.jpg" alt="Serengeti Wildlife">
                </div>
                
                <!-- Small Image 3 -->
                <div class="small-image">
                    <img src="img/7-day-kilimanjaro-lemosho-route.jpg" alt="Ngorongoro Crater">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="kilimanjaro-day-header">
                            <div class="kilimanjaro-day-title">
                                ...
                                <div class="kilimanjaro-day-info">
                                    ...
                                    <p>Begin your adventure through pristine rainforest</p>
                                </div>
                            </div>
                        ...
                        <div class="kilimanjaro-day-content">
                            ...
                            <div class="kilimanjaro-day-highlights">
                                ...
                                <div class="highlight-item">
                                    ...
                                    <span>Wilderness Experience</span>
                                </div>
                                <div class="highlight-item">
                    ...
                    <div class="kilimanjaro-day">
                        <div class="kilimanjaro-day-header">
                            <div class="kilimanjaro-day-title">
                                ...
                                <div class="kilimanjaro-day-info">
                                    <h3>Mti Mkubwa to Shira 1 Camp</h3>
                                    <p>Ascend to the spectacular Shira Plateau</p>
                                </div>
                            </div>
                            <span class="kilimanjaro-day-toggle">+</span>
                        </div>
                        <div class="kilimanjaro-day-content">
                            ...
                            <div class="kilimanjaro-day-highlights">
                                ...
                                <div class="highlight-item">
                                    ...
                                    <span>Gradual Acclimatization</span>
                                </div>
                            </div>
                            
                            <div class="kilimanjaro-day-stats">
                                <p><i class="fas fa-walking"></i> Trekking Time: 5-6 hours</p>
                                <p><i class="fas fa-mountain"></i> Elevation: 3,505m</p>
                        ...
                        <div class="kilimanjaro-day-header">
                            <div class="kilimanjaro-day-title">
                                ...
                                <div class="kilimanjaro-day-info">
                                    ...
                                    <p>Explore the high-altitude wilderness</p>
                                </div>
                            </div>
                            <span class="kilimanjaro-day-toggle">+</span>
                        </div>
                    ...
                    <div class="kilimanjaro-day">
                        ...
                        <div class="kilimanjaro-day-content">
                            ...
                            <div class="kilimanjaro-day-highlights">
                                ...
                                <div class="highlight-item">
                                    <i class="fas fa-lungs"></i>
                                    <span>Optimal Acclimatization</span>
                                </div>
                            </div>
                    ...
                    <div class="kilimanjaro-day">
                        <div class="kilimanjaro-day-header">
                            <div class="kilimanjaro-day-title">
                                ...
                                <div class="kilimanjaro-day-info">
                                    <h3>Barafu Camp to Uhuru Peak and Descend to Mweka Gate</h3>
                                    <p>Summit day and final descent</p>
                                </div>
                            </div>
                            <span class="kilimanjaro-day-toggle">+</span>
                        </div>
                        <div class="kilimanjaro-day-content">
                            ...
                            <div class="kilimanjaro-day-stats">
                                ...
                                <p><i class="fas fa-hotel"></i> Transfer to hotel & departure</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Rest of the code remains exactly the same (Booking Popup, Inclusions/Exclusions, FAQ, etc.) -->
...
<!--<div class="booking-popup-overlay" id="bookingPopupOverlay">
        ...
        <div class="booking-popup-heading">
            <h3>Book Your Kilimanjaro Trek</h3>
            <p>Reserve your spot for this unforgettable mountain adventure</p>
        </div>
        ...
        <form class="booking-popup-form" id="kilimanjaro-booking-form">
            ...
            <div class="popup-form-row">
                ...
                <div class="popup-form-group">
                    <label for="popup-group-size">Select Route</label>
                    <select id="popup-group-size" name="group-size" required>
                        ...
                        <option value="Lemosho Route" selected>Lemosho Route</option>
                        <option value="Umbwe route">Umbwe route</option>
                        <option value="Northern circuit route">Northern circuit route</option>
                    </select>
                </div>
            </div>
            ...
            <div class="popup-form-group">
                ...
                <textarea id="popup-special-requests" name="special-requests" rows="3" placeholder="Any dietary requirements, medical conditions, or other requests"></textarea>
            </div>
                ...
                <div class="inclusions-list">
                    ...
                    <div class="inclusion-item">
                        ...
                        <div class="inclusion-content">
                            ...
                            <p>All park entry fees, rescue fees, and transfers to/from Londorossi Gate</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="kilimanjaro-faq-container">
                ...
                <div class="kilimanjaro-faq-item">
                    ...
                    <div class="kilimanjaro-faq-answer">
                        <p>Success rates vary by route and duration. Generally, longer routes have higher success rates due to better acclimatization. <span class="route-name">Lemosho Route</span> (7 days: 85-90%, 8 days: 90-95%), <span class="route-name">Machame Route</span> (7 days: 85-90%, 6 days: 75-85%), <span class="route-name">Marangu Route</span> (6 days: 65%, 5 days: 50%). The 7-day Lemosho offers one of the highest success rates with excellent acclimatization.</p>
                    </div>
                </div>
                ...
                <div class="kilimanjaro-faq-item">
                    ...
                    <div class="kilimanjaro-faq-answer">
                        <p>The <span class="route-name">Lemosho Route</span> is considered one of the best routes for acclimatization with a gradual ascent profile. While no mountaineering experience is required, excellent physical fitness is essential. You should be comfortable hiking 5-7 hours daily with a daypack. The route's wilderness nature and longer approach make it ideal for those seeking a more remote experience.</p>
                    </div>
                </div>
                ...
                <div class="kilimanjaro-faq-item">
                    ...
                    <div class="kilimanjaro-faq-answer">
                        <p>The <span class="route-name">Lemosho Route</span> uses high-quality mountain tents for accommodation. Our camping equipment includes comfortable sleeping mats, and we provide spacious dining tents with camp chairs and tables. All accommodations are selected for safety, comfort, and minimal environmental impact. The remote campsites on Lemosho offer a true wilderness experience.</p>
                    </div>
                </div>
                ...
                <div class="kilimanjaro-faq-item">
                    ...
                    <div class="kilimanjaro-faq-answer">
                        <p>Yes, the 7-day Lemosho route is excellent for first-time high-altitude climbers. The gradual ascent profile and excellent acclimatization opportunities make it ideal for beginners. The key factors are good physical fitness, mental preparedness, and the route's wilderness experience. We recommend discussing any health concerns with your doctor before booking.</p>
                    </div>
                </div>
...
customizeKilimanjaroFAQ('Lemosho Route', '7 days', '85-90%', 'Strenuous', 'Premium wilderness experience and scenic diversity');
//customizeKilimanjaroFAQ('Machame Route', '7 days', '85-90%', 'Strenuous', 'Highest success rate');
